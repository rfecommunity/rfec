      ...
      <div className="container px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 lg:gap-12">
          <div className="space-y-3">
            ...
            <div className="flex space-x-3 border-b border-muted-foreground pb-8">
              <a
        ...
        <div className="mt-6 pt-6 border-t border-muted-foreground flex flex-col md:flex-row items-center justify-between">
